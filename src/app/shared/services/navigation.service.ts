    ...
    this.onlineShopMenu = [
      {
        ...
        title: 'Order Board',
        type: 'link',
        icon: 'assets/images/sidebar/order-board.png',
      ...
      },
      {
        ...
        title: 'Order Status',
        type: 'link',
        icon: 'assets/images/sidebar/order-status.png',
        icontType: InconsTypeEnum.ICons_FontAwesome.toString(),
      ...
      },
      {
        ...
        title: 'Shipping',
        type: 'link',
        icon: 'assets/images/sidebar/shipping.png',
        icontType: InconsTypeEnum.ICons_FontAwesome.toString(),
      ...
      },
      {
        ...
        title: 'Coupons',
        type: 'link',
        icon: 'assets/images/sidebar/coupons.png',
        icontType: InconsTypeEnum.ICons_FontAwesome.toString(),
      ...
      },
      {
        ...
        title: 'Products',
        type: 'link',
        icon: 'assets/images/sidebar/products.png',
        icontType: InconsTypeEnum.ICons_FontAwesome.toString(),
      ...
      },
      {
        ...
        title: 'Pages',
        type: 'link',
        icon: 'assets/images/sidebar/pages.png',
        icontType: InconsTypeEnum.ICons_FontAwesome.toString(),
      ...
      },
      {
        ...
        title: 'Store Front',
        type: 'link',
        icon: 'assets/images/sidebar/storefront.png',
        icontType: InconsTypeEnum.ICons_FontAwesome.toString(),
      ...
      },
      {
        ...
        title: 'Settings',
        type: 'link',
        icon: 'assets/images/sidebar/settings.png',
        icontType: InconsTypeEnum.ICons_FontAwesome.toString(),
      ...
      },
      {
        ...
        title: 'Communication',
        type: 'link',
        icon: 'assets/images/sidebar/communication.png',
        icontType: InconsTypeEnum.ICons_FontAwesome.toString(),
